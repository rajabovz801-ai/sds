...
export function AdminMenuPreview() {
  ...
  return (
    <>
          ...
          <section className="adminMenuPreviewModal" role="dialog" aria-modal="true" aria-label="Test menyusi">
            <header className="adminMenuPreviewHead">
              <div>
                ...
                <p>Barcha bo‘limlarga qo‘shilgan testlarni shu yerdan ko‘ring. Bu oynadan test urinish boshlanmaydi.</p>
              </div>
                        ...
                        <div className="adminMenuPreviewTests">
                          {rows.length ? rows.map((test) => (
                            <div className="adminMenuPreviewTest" key={test.id}>
                              ...
                              <a href={`/api/tests/${test.id}/content`} target="_blank" rel="noreferrer">Ko‘rish</a>
                            </div>
                          )) : (
      ...
      <style>{`
        .adminMenuPreviewTrigger{position:fixed;z-index:160;top:24px;right:206px;height:39px;padding:0 13px;border:1px solid rgba(255,255,255,.13);border-radius:12px;background:rgba(255,255,255,.09);color:#eef4fa;display:flex;align-items:center;gap:7px;font:800 8px/1 "Avenir Next","Segoe UI Variable","SF Pro Display","Helvetica Neue",Arial,sans-serif;cursor:pointer;backdrop-filter:blur(12px);transition:.18s ease}.adminMenuPreviewTrigger:hover{background:rgba(255,255,255,.15)}.adminMenuPreviewTrigger svg{width:15px!important;height:15px!important}
        ...
        .adminMenuPreviewTests{padding:8px 12px 12px}.adminMenuPreviewTest{min-height:65px;padding:9px 4px;display:grid;grid-template-columns:39px minmax(0,1fr) auto;align-items:center;gap:10px;border-bottom:1px solid rgba(14,32,56,.07)}.adminMenuPreviewTest:last-child{border-bottom:0}.adminMenuPreviewFile{width:38px;height:38px;padding:10px;border-radius:12px;background:#edf1f1;color:#315d63}.adminMenuPreviewFile svg{width:100%!important;height:100%!important}.adminMenuPreviewTest h4{margin:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:10px}.adminMenuPreviewTest p{margin:3px 0 5px;color:#9199a3;font-size:7px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.adminMenuPreviewTest div>span{display:inline-block;padding:3px 6px;border-radius:999px;font-size:6px;font-weight:850}.adminMenuPreviewTest div>span.published{background:#e6f5ec;color:#24734f}.adminMenuPreviewTest div>span.draft{background:#fff1d9;color:#8a6724}.adminMenuPreviewTest>a{height:31px;padding:0 10px;border:1px solid rgba(14,32,56,.11);border-radius:9px;background:#fff;color:#243b57;display:flex;align-items:center;font-size:7px;font-weight:850}.adminMenuPreviewTest>a:hover{background:#10233f;color:#fff}.adminMenuPreviewEmpty,.adminMenuPreviewState{min-height:120px;display:grid;place-items:center;text-align:center;color:#8b949e;font-size:8px}.adminMenuPreviewState{min-height:310px}.adminMenuPreviewState.error{color:#b44137}
        @media(max-width:900px){.adminMenuPreviewTrigger{right:72px}.adminMenuPreviewBackdrop{padding:12px}.adminMenuPreviewModal{max-height:calc(100vh - 24px);border-radius:22px}.adminMenuPreviewSkills{grid-template-columns:1fr}}
        @media(max-width:560px){.adminMenuPreviewTrigger{top:25px;right:66px;width:39px;padding:0;justify-content:center}.adminMenuPreviewTrigger span{display:none}.adminMenuPreviewHead{padding:19px}.adminMenuPreviewHead h2{font-size:22px}.adminMenuPreviewTracks{padding:10px}.adminMenuPreviewTracks button{min-width:0;flex:1}.adminMenuPreviewBody{padding:10px}.adminMenuPreviewTest{grid-template-columns:36px minmax(0,1fr)}.adminMenuPreviewTest>a{grid-column:2;justify-self:start}}
      `}</style>
    </>
  );
}
