...
export default function Home(){
 ...
 async function handleSubmit(e:React.FormEvent){
  e.preventDefault();
  if(registeredUsername){window.location.assign("/dashboard");return}
  setBusy(true);setMessage("");
  try{
   const payload=mode==="register"?{action:"register",first_name:first.trim(),last_name:last.trim(),invite:access.trim(),target_band:Number(target),password}:{action:"login",username:username.trim().toLowerCase(),password};
