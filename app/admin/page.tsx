...
export default async function AdminPage() {
  ...
  return <div className="adminRoot"><AdminTestScopeBridge /><AdminLargeHtmlUploadBridge /><AdminReadableTypography /><AdminPanelSafetyPolish /><AdminClient /><AdminMenuPreview /><AdminProfessionalLayer /><AdminOverviewProPolish /><AdminResultsFilterFix /><AdminStudentResultsDropdown /><AdminTestManagerDropdown /><AdminToolsHub /></div>;
}
