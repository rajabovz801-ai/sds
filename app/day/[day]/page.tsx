...
export default function DayPage(){
 ...
 const scheduledReading=[1,2,5,6,8,9,12,13,14,15].includes(day),iso=date.toISOString().slice(0,10);
 ...
 return <main className="cd-day ch-layout">
  ...
  <div className="cd-day-body">
   ...
   <div className="cd-day-stats" aria-label="Daily learning plan overview">
    ...
    <div className="cd-day-stat"><BookOpen size={20}/><div><span>READING PLAN</span><strong>{scheduledReading&&!sunday?"02":"—"}</strong><small>{scheduledReading&&!sunday?passageType+" practices":"Not scheduled today"}</small></div></div>
