 ...
 return <main className="cd-day ch-layout">
  ...
  <div className="cd-day-body">
   ...
   <div className="cd-day-stats" aria-label="Daily learning plan overview">
    ...
    <div className="cd-day-stat"><BookOpen size={20}/><div><span>READING PLAN</span><strong>{scheduledReading&&!sunday?"02":"—"}</strong><small>{scheduledReading&&!sunday?"Passage 1 practices":"Not scheduled today"}</small></div></div>
